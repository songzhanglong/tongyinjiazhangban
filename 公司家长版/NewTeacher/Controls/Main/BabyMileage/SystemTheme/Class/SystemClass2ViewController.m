...
@interface SystemClass2ViewController ()

@end

@implementation SystemClass2ViewController
...
- (void)createTableHeaderView{
    if (!_tableView.tableHeaderView) {
        ...
        UIView *headView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, winSize.width, 30 + 100 + 30 + 18 + 10 + 18 + 30 + (hasContent ? 40 : 0))];
        ...
        if (hasContent) {
            UIView *downView = [[UIView alloc] initWithFrame:CGRectMake(0, label2.frameBottom + 30, headView.frameWidth, 40)];
